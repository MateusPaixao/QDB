...
function flagProdomocao(){
    ...
    var arrayFlags = [
        { flag_name: 'produtos top' , flag_class: 'tag produtos-top', orderId: 1 },
        { flag_name: 'novidade' , flag_class: 'tag novidade', orderId: 2 },
        { flag_name: 'so no sote' , flag_class: 'tag so-no-sote', orderId: 3 },
        { flag_name: '15' , flag_class: 'tag 15', orderId: 4 },
        { flag_name: 'frete gratis' , flag_class: 'tag frete-gratis', orderId: 5 },
        { flag_name: 'tempo limitado' , flag_class: 'tag tempo-limitado', orderId: 6 },
        { flag_name: 'noite da beleza' , flag_class: 'tag noite-da-beleza', orderId: 7 },
        { flag_name: 'liquida bere' , flag_class: 'tag liquida-bere', orderId: 8 },
        { flag_name: 'black friday' , flag_class: 'tag black-friday', orderId: 9 },
        { flag_name: 'black week' , flag_class: 'tag black-week', orderId: 10 },
    ];
...
function aviseme($this){
    $('.notifyme-title-div .notifymetitle.notifyme-title').html("<div class='rw-indisponivel'><h3>Produto indisponível :( </h3><h3>Preço sugerido: </h3><h4 class='rw-indisponivel--price'> R$"+parseFloat(dataLayer[0].productListPriceFrom).toFixed(2).replace('.',',')+"</h4></div>");
    setTimeout(function(){
