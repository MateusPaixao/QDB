      ...
      card: [
        {
          ...
          description:
            'Quer brilhar muito neste carnaval?  Faça sua maquiagem com um de nossos especialistas e saia de nossa loja direto pra festa.'
        },
        {
          ...
          title: 'passo a passo carnaval quem disse, Berenice?',
          description:
            'Sabe aquela maquiagem que é colorida e elegante ao mesmo tempo? Agende um horário com o Menu de Makes e encha seu carnaval de cor.'
        },
        {
          ...
          title: 'passo a passo carnaval quem disse, Berenice?',
          description:
            'Faça aquela maquiagem que é a cara do Carnaval, e claro, sua cara também. Agende seu horário com um de nossos especialistas.'
        }
      ]
    };
  }
      ...
      <div className="makeContainer">
        ...
        <div className="makeContainer__product">
          {this.state.card.map((card, i) => (
            <div className="makeContainer__individual" key={i}>
              ...
              <div className="makeContainer__individual__info">
                ...
                <a
                  className="productCard__button makeContainer__button"
                  href="https://www.servicosquemdisseberenice.com.br/"
                >
                  Agendar
                </a>
              </div>
