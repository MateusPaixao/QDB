    ...
    buildBag(){
        class Bag extends React.Component {
            ...
            render(){
                return(
                <React.Fragment>
                <div class="header__options--item__cartBag">
                    <svg class="__maskBag" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="-5 -4 91 99" preserveAspectRatio="xMidYMax slice">
                        <defs>
                            <mask id="mask" x="0" y="0" width="76" height="76">
                                <defs>
                                    <path id="wave" class="__wave" fill="#000" d="M-363.852,502.589c0,0,236.988-41.997,505.475,0
                        ...
                        <path mask="url(#mask)" d="M70.5 24.4h-15v-4.9C55.5 8.8 47.1.2 36.9.2 26.7.2 18.3 8.8 18.3 19.5v4.9h-15C2 24.4.9 25.5.9 26.8v59.9c0 4 3.2 7.2 7.2 7.2h57.5c4 0 7.2-3.2 7.2-7.2V26.8c.1-1.4-.9-2.4-2.3-2.4zm-46.1-5C24.4 12.1 30 6.1 37 6.1s12.6 6 12.6 13.3v4.9H24.4v-4.9z"></path>
                    </svg>
                    <svg class="__bag" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 -4 80 99">
                    ...
                    <p class="minicart--itens">{this.state.Qty}</p>
                </div>
                </React.Fragment>
                )
            }
