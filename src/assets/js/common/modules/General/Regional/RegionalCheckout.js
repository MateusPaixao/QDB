...
var regionalization = {
        ...
        this.getOrderForm(function(orderForm){
            if (orderForm.shippingData && localStorage.getItem("pricetablestate") != null) {
                if (orderForm.shippingData.address) {
                    if (_self.regions[orderForm.shippingData.address.state].utm != localStorage.getItem("pricetablestate")) {
    ...
    modalHtml: function() {
        return '<div class="modal-overlay" id="modal-region">' + 
    ...
    controllerModal: function() {
        $('#modal-region').on('click', '.btn-modal-close', function(event) {
            $('#modal-region').hide();
        });
    },
    ...
    isEmpty: function(value) {
        return (value == null || value == "" || value == undefined || value == "undefined") ? true : false;
    },
