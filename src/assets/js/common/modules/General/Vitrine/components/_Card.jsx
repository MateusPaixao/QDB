...
class Card extends React.Component{
  ...
  mountConfig(){
    const getImgSku = (sku) => {
      ...
      if(skuImg.length > 0){
        // return skuImg
        return skuImg[0].imageTag.match(/([^">]+)"*\.(?:jpg|gif|png)/)[0].allReplace({ "#width#": "50", "#height#": "50" , "~": ""});
      }
    }
        ...
        <ul className="cardProduct__config__list">
        {
          this.props.info.items.map(sku => 
            <li className="cardProduct__config__list__item" data-name={sku["Escolha a Cor"]} data-sku={sku.itemId}>
              ...
              <img data-src={getImgSku(sku)} alt={sku["Escolha a Cor"]} />
      ...
      <div className={"cardProduct avaliable-" + this.state.Avaliable} data-prod={this.props.info.productId} /*onMouseEnter={this.toggleHover} onMouseLeave={this.toggleHover}*/>
        ...
        <a href={"/" + this.props.info.linkText + "/p?idsku=" + this.state.Sku.itemId} className="cardProduct__link">
          ...
          <div className="cardProduct__pictureContainer">
            ...
            <img className="cardProduct__pictureContainer__picture" src="https://qbbr.vteximg.com.br/arquivos/QDBLoad.gif" data-src={this.state.Sku.images[0].imageTag.match(/([^">]+)"*\.(?:jpg|gif|png)/)[0].allReplace({ "#width#": "150", "#height#": "150" , "~": ""})} loading="lazy"></img>
          </div>
