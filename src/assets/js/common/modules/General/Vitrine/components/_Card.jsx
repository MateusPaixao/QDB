  ...
  addToCart(e){
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        `${this.state.Sku.name} foi adicionado!`
        e.querySelector(".status--adding__dots").innerHTML = 
        `<span class="status--adding__dots__cart">
          <svg class="status--adding__dots__cart__icon" width="59" height="78" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M43.826 21.452v-7.15C43.826 6.398 37.416 0 29.5 0c-7.917 0-14.326 6.398-14.326 14.302v7.15H2.922L0 69.438v.188C0 74.236 3.77 78 8.388 78h42.224C55.23 78 59 74.236 59 69.626l-2.922-48.174H43.826zm-24.034-7.15c0-5.27 4.336-9.598 9.614-9.598a9.585 9.585 0 0 1 9.613 9.598v7.15H19.792v-7.15z" /></svg>
        </span>
        ...
        //   setTimeout(() => {
        //     e.classList = "cardProduct--addToCart";
        //   }, 800);
    ...
    return (
      <div className={`cardProduct avaliable-${this.state.Avaliable} change-${this.state.openConfig}`} data-prod={this.props.info.productId} /*onMouseEnter={this.toggleHover} onMouseLeave={this.toggleHover}*/>
        <span className={`cardProduct--change`} onClick={e => this.openConfig(e)}>
          <svg className="cardProduct--change__engine" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 7.485l-8.208 8.207a1.05 1.05 0 0 1-1.484-1.485L16.515 6H13a1 1 0 1 1 0-2h6a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0V7.485zM2 8.515L10.207.308a1.05 1.05 0 0 1 1.486 1.484L3.485 10H7a1 1 0 1 1 0 2H1a1 1 0 0 1-1-1V5a1 1 0 0 1 2 0v3.515z"/></svg>
          ...
          <p className="cardProduct--change__title">Opções do Produto</p>
