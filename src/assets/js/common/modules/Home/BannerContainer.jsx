...
import Banner from "./Components/BannerPrincipal.jsx"
    ...
    BuildBanners(){
        class BannerContainer extends React.Component {
            constructor(props){
                ...
                // this.buildBanners = this.buildBanners.bind(this);
            }
            ...
            componentDidMount(){
                ...
                //     var node = document.querySelector(".bannerHero__banners")
            ...
            render(){
                const Banners = () => {
                    ...
                    this.state.Banners.map((Banner, index) => {
                      banners.push(
                        <Banner Url={Banner.Url} Src={Banner.Src} key={index} />
                      );
                    })
                    return (
                      <React.Fragment>
