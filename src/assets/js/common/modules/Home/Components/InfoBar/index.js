                ...
                return (
                    <React.Fragment>
                        ...
                        <div className="__container" onClick={() => this.toggleModal()}>
                            <span className="__icon firstIcon" ><svg xmlns="http://www.w3.org/2000/svg" width="37" height="32"><defs><clipPath id="a"><path d="M0 0h37v32H0z" /></clipPath></defs><g data-name="Prancheta – 15" clipPath="url(#a)"><g transform="translate(4.406 2.06)" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" fill="none"><path data-name="Retângulo 959" d="M.594 2.94h18.643v15.847H.594z" /><path data-name="Caminho 987" d="M18.937 8.994h4.947l3.71 3.71v6.183h-8.657z" /><circle data-name="Elipse 43" cx="3.263" cy="3.263" r="3.263" transform="translate(3.39 18.415)" /><circle data-name="Elipse 44" cx="3.263" cy="3.263" r="3.263" transform="translate(18.651 18.415)" /></g></g></svg></span>
                            <p className="__content"><a href="/busca/?fq=P:[109TO300]&O=OrderByBestDiscountDESC"> frete grátis </a> nas compras a partir de {this.state.Infos[0].Content}<a href="/busca/?fq=P:[109TO300]&O=OrderByBestDiscountDESC" className="_ctaModal"></a></p>
                        ...
                        <div className="__container" onClick={() => this.togglePaymentModal()}>
                            <span className="__icon thirdIcon" ><svg xmlns="http://www.w3.org/2000/svg" width="37" height="32"><defs><clipPath id="a"><path d="M0 0h37v32H0z" /></clipPath></defs><g data-name="Prancheta – 17" clipPath="url(#a)"><path d="M34 24.105V7.895A2.719 2.719 0 0031.5 5h-25A2.719 2.719 0 004 7.895v16.21A2.719 2.719 0 006.5 27h25a2.719 2.719 0 002.5-2.895zM6.5 6.158h25A1.632 1.632 0 0133 7.895v1.158H5V7.895a1.632 1.632 0 011.5-1.737zM5 10.211h28v3.473H5zm1.5 15.631A1.632 1.632 0 015 24.105v-9.263h28v9.263a1.632 1.632 0 01-1.5 1.737z" fill="#000" /></g></svg></span>
                        ...
                        <a href="/servicos">
                            <div className="__container">
                                <span className="__icon fourthIcon" ><svg xmlns="http://www.w3.org/2000/svg" width="37" height="32"><defs><clipPath id="a"><path d="M0 0h37v32H0z" /></clipPath></defs><g fill="#fff" data-name="Prancheta – 18" clipPath="url(#a)"><path data-name="Caminho 989" d="M14.65 15.283h-.275V13.35a.447.447 0 00-.473-.415h-.037V8.981a.413.413 0 00-.262-.371L9.942 7.005a.531.531 0 00-.46.018.406.406 0 00-.224.353v5.56h-.041a.447.447 0 00-.473.415v1.933h-.269a.447.447 0 00-.473.415v10.887a.447.447 0 00.473.415h6.178a.447.447 0 00.473-.415V15.698a.447.447 0 00-.476-.415zm-4.446-7.236l2.715 1.19v3.7h-2.715zm-.514 5.718h3.742v1.518H9.691zm4.485 12.409h-5.23V16.113h5.23z" /><path data-name="Caminho 990" d="M30.535 23H15.463a.456.456 0 100 .912h14.335l-.106.217a3.545 3.545 0 01-3.172 1.959H15.463a.456.456 0 100 .912h11.055a4.479 4.479 0 004.008-2.476l.426-.87a.449.449 0 00-.025-.44.466.466 0 00-.392-.214z" /><path data-name="Caminho 991" d="M12.069 8.478a9.519 9.519 0 1112.563 14.3.473.473 0 10.607.726 10.465 10.465 0 10-13.813-15.72.473.473 0 10.643.694z" /></g></svg></span>
