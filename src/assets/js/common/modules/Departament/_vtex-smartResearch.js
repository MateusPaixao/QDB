    ...
    SmartResearch(){
        ...
        jQuery.fn.vtexSmartResearch=function(opts)
        {
            ...
            var defaults=
            {
                ...
                loadContent:".pratileira[id^=ResultItems]", // Elemento que esta em volta da(s) pratileira(s) de produtos.
                shelfClass:".pratileira", // Pratelira de produtos (filha do elemento definido de um "loadContent")
                ...
                // Callback após inserir a pratileira na página
                ...
                ajaxCallback:function(){
                    ...
                    setTimeout(function(){
                    if($(".products:eq(0) .pratileira.vitrine ul li").length <= 14){
                        $(".pager.bottom").hide();
                    }else{
                        $(".pager.bottom").show();
                    }
