  ...
  buildSlider() {
    ...
    function printSlideIndex() {
      ...
      Autoplay = setInterval(() => {
        this.innerElements.length - 1 === this.currentSlide ? this.goTo(0) : slideBanners.next();
      }, 10000);
    ...
    Siema.prototype.addPagination = function() {
      ...
      document.querySelector('.paineisContainer').appendChild(dotControl);
    ...
    Siema.prototype.addArrows = function() {
      ...
      document.querySelector('.paineisContainer').appendChild(arrowsControl);
    ...
    if (document.querySelector('.paineis div').childElementCount >= 3) {
