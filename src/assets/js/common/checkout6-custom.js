...
var promotionData = [{ 
    "906": { //idSku
        ...
        discountPercent: 1.0 //porcentagem
    },
    "1910": { //idSku
...
// BARRA DE OFERTAS
// var ofertasBar = function () {
//     _itemDiscount.forEach( 
//         function(item, _attrIdsku, _array) { 
//             _attrIdsku = item.getAttribute("data-sku");
//             console.log(_attrIdsku);
//             _productToActive = item.querySelectorAll('._product');
//             _sarrafoPromotion = promotionData[0][_attrIdsku].activeValue;
//             _promoActive = _productToActive[0].classList.contains('promoActive');

//             _productToActive.forEach(
//                 function (item, index) {
//                     if(_promoActive == false){
//                         item.classList.add("promoApplied"); 
//                     return true
//                     }
