...
var promotionData = [{ 
    "906": { //idSku
        ...
        discountPercent: 40.50 //porcentagem
    },
    "1910": { //idSku
        activeValue: 80.00, //valor do sarrafo(carrinho)
        discountPercent: 80.50 //porcentagem
    },
    "1259": { //idSku
        activeValue: 120.00, //valor do sarrafo(carrinho)
        discountPercent: 20.50 //porcentagem
    } 
}]; 

__skus = []; 
promotionData.forEach(function(e){
    __skus = Object.keys(e);
});
...
var applyPromotionDiscount = function () {
    _itemDiscount.forEach( 
        function(item, _attrIdsku, _array) { 
            ...
            _sarrafoPromotion = promotionData[0][_attrIdsku].activeValue;
